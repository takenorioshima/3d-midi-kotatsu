import { AbstractMesh, Color3, PointLight, Scene, SceneLoader, StandardMaterial, TransformNode, Vector3 } from "@babylonjs/core";
  ...
  constructor(public scene: Scene) {
    ...
    SceneLoader.ImportMeshAsync("", "./models/", "kotatsu.glb", scene)
      .then((result) => {
        ...
        // Heater Light
        this.heaterLight = new PointLight("heaterLight", new Vector3(0, 0.3, 0), scene);
